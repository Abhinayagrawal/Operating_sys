...
//		char mode[128];
	...
	public:
		...
		bool isSystemReady;
                ...
                void blockAllocationCheck(int inum, vector<int> *allocatedBlockList);
                void blockFreeCheck(vector<int> allocatedBlockList);

                void defragMover(map<int,int> &blockInodeMap);
                int updateInode(short inum, int oldBlockNum, int newBlockNum);
};
