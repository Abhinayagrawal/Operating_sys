...
class IndexNode
{
	public:
		...
		const static int MAX_FILE_BLOCKS = MAX_DIRECT_BLOCKS + 256/3;
	...
	public:
		...
		void setIndirectBlock(int block);
		...
		void copy(IndexNode& indexNode);
                //static int getMaxFileBlocks();
                //static void setMaxFileBlocks(int maxFileBlocks);
};
#endif
